...
const user: CurrentUser = { id: "1", name: "Ada Admin", email: "admin@example.com", phone: null, firstName: "Ada", lastName: "Admin", role: "SUPER_ADMIN", isActive: true, permissions: ["restaurants.create"], memberships: [] };
